...
public class Config {
    ...
    private static final ModConfigSpec.BooleanValue LOG_DIRT_BLOCK = BUILDER.comment("Whether to log the dirt blockentity on common setup").define("logDirtBlock", true);
